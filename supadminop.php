  ...
  <div class="row" style="text-align: center;">
        ...
        <table  class="table table-bordered" width="auto" border="0">
                <tr>
                   ...
                   <a href="supadminop.php" style="color: white;"><strong>Patient Information Modification</strong></a></td>

                   <td style="height: 50px; padding-top:15px">
                   <a href="supadminopsm.php" style="color: white;"><strong>Staff Information Modification</strong>\</a></td>
                </tr>
        </table>
...
<table style="background-color: rgba(222,444,444,0.0);" class="table table-responsive" width="500" border="0"><form action="" method="post">
  <tr>
    <td><input style="font-size:12px" type="text" name="searvalu" class="form-control" placeholder="Enter Registration No...."/></td>
  </tr><tr align="center">
...
<form class="" action="" method="post" id="upform">
  ...
  <dd style="font-size:12px;"><?php echo $row["Pet_opdid"]; ?><br> <a target="_blank" href="admitdf.php?id= <?php echo $row["Pet_opdid"]; ?>" name="ad"> Doctor Information </a></dd>
...
<dl>
  ...
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="suadpeted.php?id=<?php echo $row["pet_id"]; ?>" style="colour:#000">Edit</a></li>
