...
<h3 style="font-family:calibri;" class="text-center">All Patients details</h3></div>
</div>
</div>
</div>
<div style="border-radius:10px; padding:25px;">
<div class="row">
<div class="col-md-12 ">
<br />
...
<th><strong>Doctor info</strong></th>
<th></th>
<th></th>
</tr>
</thead>
...
<tr valign="middle">
    ...
    <td  align="center"><a target="_blank" href="opdinvo.php?id=<?php echo $row["pet_id"]; ?>" name="ad">Make normal Invoice</a></td>
