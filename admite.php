...
<h3 style="font-family:calibri;" class="text-center">Admitted Patient Informations</h3></div>
</div>
</div>
</div>
...
<tr>
    ...
    <td align="center">Room No:<?php echo $row["admit_rn"]; ?></td>
      <td align="center"><a target="_blank" href="admiteinvo.php?id=<?php echo $row["admit_petid"];?> & rid=<?php echo $row["admit_rn"];?> & mid=<?php echo $row["pet_id"];?>">Discharge the patient</a></td>
</tr>
<?php $count++; } ?>
</tbody>
</table>
