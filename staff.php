...
<div class="row" style="text-align: center;">
        ...
        <table  class="table table-bordered" width="auto" border="0">
                <tr>
                   ...
                   <a href="supadmst.php" style="color: white;">Staff Member Edit and Delete</a></td>
                </tr>
        </table>
...
<h3 style="font-family:calibri;" class="text-center">Staff Registration</h3></div>
<br />
...
<h3 class="panel-title text-center">Staff Registration form</h3>
</div>
<center>
...
('<?php echo $emlduperr; ?>');</script></td>
  ...
  <tr>
    ...
    <option value="Nurse">Clinical</option>
    <option value="Nurse">Surgeon</option>
    <option value="Nurse">Nurse</option>
    <option value="Nurse">Medical Record Clerk</option>
