...
<h3 style="font-family:calibri;" class="text-center">Room Details edit form </h3></div>
<br />
<div class="container">
<div class="row">
</div>
...
<h3 class="panel-title text-center">Room Details edit Form</h3>
</div>
<center>
...
<div align="left">Doctor for Morning:</div>
    ...
    <div align="left"> Select Doctor for Evening</div>
        <select required  name="erdo"  style="margin:5px;  border-radius:0px" class="form-control">
        <option value="">Doctor for Eveninge</option>
        <?php
            $count = 1;
