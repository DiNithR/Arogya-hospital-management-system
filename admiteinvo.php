...
<div class="row" style="text-align: center;">
        ...
        <table  class="table table-bordered" width="auto" border="0">
                <tr>
                   ...
                   <a href="admiteinvo.php" style="color: white;">
                   <strong>Patients Admited Invoices</strong></a></td>
                </tr>
        </table>
...
<h3 style="font-family:calibri;" class="text-center">Patients Admited Invoice</h3></div>
<br />
...
<tr>
    ...
    <tr>
        <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 ">Count of days (Per day Rs.1000.00)<input name="cod"  required="required"   type="number" class="form-control" placeholder="Count of days"></div></td>
        </tr>
