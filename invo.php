...
<div class="row" style="text-align: center;">
        ...
        <table  class="table table-bordered" width="auto" border="0">
                <tr>
                   ...
                   <td style="height: 50px; padding-top:15px">
                   <a href="invoadinfo.php" style="color: white;">Admited Patients Invoiceses</a></td>
...
<form id="sreg" name="sreg" action="" method="post">
  <tr>
    ...
    <div class="input-group col-md-12 col-xs-12">
      <input required  name="pname"   type="text" class="form-control" placeholder="Patient Name">
	</div>
    ...
    <td colspan="2" style="padding:5px">
    <div class="input-group col-md-12 col-xs-12">
      <input required name="dname" id="lname"   type="text" class="form-control" placeholder="Doctor Name">
	</div>
    </td>
  </tr>
...
<tr>
    <td colspan="2" style="padding:5px">
    <div class="input-group col-md-12 col-xs-12 ">
      <input name="mc"  required="required"   type="number" class="form-control" placeholder="Medicine Charge"></div></td>
    </tr>
<tr>
